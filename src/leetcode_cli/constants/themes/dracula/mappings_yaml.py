...
INTERPRETATION:
  ...
  Accepted:
    ansi: "dracula_purple,bold"          # Styles: Purple color and bold text for accepted submissions
    symbol: "checkmark"                   # Symbol representing acceptance
  Wrong Answer:
    ansi: "dracula_red,bold"              # Styles: Red color and bold text for wrong answers
    symbol: "cross"                       # Symbol representing a wrong answer
  Memory Limit Exceeded:
    ansi: "dracula_red,bold"              # Styles: Red color and bold text for memory limit exceeded
    symbol: "cross"                       # Symbol representing memory limit exceeded
  Output Limit Exceeded:
    ansi: "dracula_red,bold"              # Styles: Red color and bold text for output limit exceeded
    symbol: "cross"                       # Symbol representing output limit exceeded
  Time Limit Exceeded:
    ansi: "dracula_red,bold"              # Styles: Red color and bold text for time limit exceeded
    symbol: "cross"                       # Symbol representing time limit exceeded
  Runtime Error:
    ansi: "dracula_red,bold"              # Styles: Red color and bold text for runtime errors
    symbol: "cross"                       # Symbol representing a runtime error
  Compile Error:
    ansi: "dracula_red,bold"              # Styles: Red color and bold text for compile errors
    symbol: "cross"                       # Symbol representing a compile error
  unknown:
    ansi: "dracula_orange,bold"           # Styles: Orange color and bold text for unknown statuses
    symbol: "cross"                       # Symbol representing an unknown status
  field:
    ansi: "dracula_white"                 # Styles: White color for field labels
...
PROBLEMSET:
  ...
  title:
    ansi: "dracula_white,bold"            # Styles: White color and bold text for titles
    symbol: ""                             # No symbol for title
  ac_rate:
    ansi: "dracula_white"                  # Styles: White color for acceptance rate percentages
    symbol: ""                             # No symbol for acceptance rate
  question_id:
    ansi: "dracula_white"                  # Styles: White color for question IDs
    symbol: ""                             # No symbol for question IDs
  Easy:
    ansi: "dracula_purple"                 # Styles: Purple color for easy difficulty labels
    symbol: ""                             # No symbol for easy difficulty labels
  Medium:
    ansi: "dracula_yellow"                 # Styles: Yellow color for medium difficulty labels
    symbol: ""                             # No symbol for medium difficulty labels
  Hard:
    ansi: "dracula_red"                     # Styles: Red color for hard difficulty labels
    symbol: ""                             # No symbol for hard difficulty labels
  ac:
    ansi: "dracula_purple,bold"            # Styles: Purple color and bold text for accepted submissions
    symbol: "checkmark"                     # Symbol representing acceptance
  notac:
    ansi: "dracula_yellow"                 # Styles: Yellow color for attempted but not accepted submissions
    symbol: "snowflake"                     # Symbol representing an attempted submission
  not_started:
    ansi: "dracula_gray"                   # Styles: Gray color for not started status
    symbol: "space"                         # Symbol representing not started status
  field:
    ansi: "dracula_white,bold"             # Styles: White color and bold text for field labels
    symbol: ""                             # No symbol for fields
...
PROBLEM_DESCRIPTION:
  ...
  code:
    ansi: "dracula_gray_bg"                 # Styles: Gray background for <code> tags
    symbol: ""                              # No symbol for <code> tags
  pre:
    ansi: "dracula_red"                      # Styles: Red text for <pre> tags
    symbol: ""                              # No symbol for <pre> tags
  tag_label:
    ansi: "dracula_white,bold"              # Styles: White color and bold text for "Tags:" label
    symbol: ""                              # No symbol for "Tags:" label
  tag:
    ansi: "dracula_cyan_bg,dracula_white,bold"  # Styles: Cyan background, white color, and bold text for individual tags
    symbol: "space"                         # Symbol representing space between tags
  language_label:
    ansi: "dracula_white,bold"              # Styles: White color and bold text for "Languages:" label
    symbol: ""                              # No symbol for "Languages:" label
  language:
    ansi: "dracula_orange_bg,dracula_black,bold" # Styles: Orange background, black color, and bold text for programming languages
  ...
  example_input_data:
    ansi: "dracula_gray"                     # Styles: Gray text for example input data
    symbol: ""                               # No symbol for example input data
  example_output_data:
    ansi: "dracula_gray"                     # Styles: Gray text for example output data
    symbol: ""                               # No symbol for example output data
  example_explanation_data:
    ansi: "dracula_gray"                     # Styles: Gray text for example explanation data
...
STATS_FORMATTER:
  ...
  EASY:
    ansi: "dracula_purple"                    # Styles: Purple color for easy difficulty stats
    symbol: ""                                 # No symbol for easy difficulty stats
  MEDIUM:
    ansi: "dracula_yellow"                    # Styles: Yellow color for medium difficulty stats
    symbol: ""                                 # No symbol for medium difficulty stats
  HARD:
    ansi: "dracula_red"                        # Styles: Red color for hard difficulty stats
    symbol: ""                                 # No symbol for hard difficulty stats
  CALENDAR_TIER0:
    ansi: "dracula_gray"                       # Styles: Gray color for calendar tier 0 (no activity)
    symbol: ""                                 # No symbol for calendar tier 0
  CALENDAR_TIER1:
    ansi: "dracula_orange,bold"                # Styles: Orange color and bold text for calendar tier 1 (some activity)
